          ...
          <form action="send_mail_finance.php" method="post" data-parsley-validate="parsley" onsubmit="return submitUserForm();">
            <div class="row">
              ...
              <div class="form-group col-md-6 col-lg-4">
                ...
                <select class="form-control custom-select w-100" name="city"  aria-required="true" aria-invalid="false" required="true">
              ...
              <div class="form-group col-md-6 col-lg-4">
                ...
                <select class="form-control custom-select w-100" name="model" aria-required="true" aria-invalid="false" required="true">
              ...
              <div class="form-group col-md-6 col-lg-4">
                <label for="inputEmail4">Select Profession<span class="parsley-required" style="color:red">*</span></label>
                <select class="form-control custom-select w-100" name="profession" required="true">
              ...
              <div class="form-group col-md-6 col-lg-4">
                <label for="inputEmail4">Salary/Savings Bank Name</label>
                <input type="text" class="form-control" name="bank_name" id="bank_name" placeholder="Account type">
              </div>
              <div class="form-group col-md-6 col-lg-4">
                <label for="inputEmail4">Annual Income (Rs.)<span class="parsley-required" style="color:red">*</span></label>
                <select class="form-control custom-select w-100" name="annual_income" required="true">
              ...
              <div class="form-group col-md-6 col-lg-4">
                ...
                <select class="form-control custom-select w-100" name="purchase_time" required="true">
            ...
            <div class="form-row">
              <div class="form-group col-md-8">
                  <label> Message </label>
                  <textarea class="form-control" name="s_message" aria-label="With textarea" placeholder="Enter your Message"></textarea>
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6 col-lg-4">
            ...
            <div class="wrap-btn">
              <button type="submit" name="submit" class="button btn-effect btn-submit">Submit now</button>
            </div>
