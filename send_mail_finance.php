...
if(isset($_POST['submit'])){
   ...
   // mail($admin,$subject2,$message2,$headers2); // admin
	 include('connection.php');
        ...
        $sql = "INSERT INTO `finance`(`name`, `email`, `phone_no`, `city`, `model`, `annual_income`, `purchase_time_frame`, `message`,`profession`,`bank_name`) VALUES ('$full_name','$to','$phone_no','$city','$model','$annual_income','$purchase_time','$s_message','$profession','$bank_name')";
