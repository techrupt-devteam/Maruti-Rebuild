        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <a class="btn bg-navy pull-right" href="<?php echo e(url('/admin')); ?>/download_services_file">Download Excel</a>  
            </div>
            <!-- /.box-header -->
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/marutiseva/public_html/rebuild/admin/resources/views/admin/booking/book_your_service.blade.php ENDPATH**/ ?>