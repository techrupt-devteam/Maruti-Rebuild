          ...
          <div class="row">  
            <div class="col-md-12">  
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                      <label for="oldpassword">Adhar Card:</label><span><a href="https://www.marutiseva.com/<?php echo e($data->adhar_card); ?>"> View</a></span>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                      <label for="oldpassword">Pan Card:</label><span><a href="https://www.marutiseva.com/<?php echo e($data->pan_card); ?>"> View</a></span>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/marutiseva/public_html/rebuild/admin/resources/views/admin/booking/view.blade.php ENDPATH**/ ?>