        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo e(url('/admin')); ?>/add_<?php echo e($url_slug); ?>" class="btn btn-primary btn-sm" style="float: right;">Add Offer Slider</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                  ...
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td>
                        <form action="<?php echo e(url('/admin')); ?>/update_offerorder_no/<?php echo e($value['slider_id']); ?>" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data"> 
                      ...
                      <td><a href="<?php echo e(url('/')); ?>/upload/seva_offer_banner/<?php echo e($value['slider_img']); ?>" data-fancybox="gallery" data-caption="Caption #1"><img src="<?php echo e(url('/')); ?>/upload/seva_offer_banner/<?php echo e($value['slider_img']); ?>" width="50" height="50"></a></td>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/marutiseva/public_html/rebuild/admin/resources/views/admin/sevaoffer/index.blade.php ENDPATH**/ ?>