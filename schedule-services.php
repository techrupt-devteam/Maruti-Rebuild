            ...
            <form action="send_mail_scheduleservice.php" id="schedule-form" method="post" data-parsley-validate="parsley" onsubmit="return submitUserForm();">
               <div class="card shadow mb-3">
                  ...
                  <div class="form-group col-md-4">
                     ...
                     <select class="form-control city custom-select w-100" required="true" aria-required="true" aria-invalid="false" name="city" id="city" onchange="check(event);check_date(eve);">
...
?>
                  ...
                  <div class="form-group col-md-4">
                     ...
                     <select class="form-control custom-select w-100" data-val="true" id="service" name="service" required="required" data-parsley-required-message="Please select service type">
                ...
                <div class="card shadow mt-4">
                  ...
                  <div class="card-body">
                      <div class="row">
                        <div class="form-group col-md-4">
                           <label for="inputAddress">Registration No <span class="parsley-required" style="color: red">*</span>
                           </label>
...
?>
                        ...
                        <div class="wrap-btn col-md-12">
                           <button  type="submit" id="submit" name="submit" class="button btn-effect btn-submit" value="Book Service"> Book Service </button>
                        </div>
                      </div>
                   </div>
                </div>
