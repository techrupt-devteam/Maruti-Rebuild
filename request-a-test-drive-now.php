...
<div class="container my-5 pb-4">
    <div class="row ">
         <div class="col-md-12 feature-car ">
           <div class="section-title mb-3">
              <span>Request a Test Drive Now</span>
              <h2>Test Drive</h2>
                  ...
                  <div class="card-body">
                      <div class="row">
                          <div class="form-group col-md-4 mt-3">
                            ...
                            <select name="model"  class="form-control custom-select w-100" aria-required="true" aria-invalid="false" required="true">
                ...
                <div class="card shadow mb-3 mt-5">
                  ...
                  <div class="card-body">
                      <div class="row">
                          ...
                          <div class="form-group col-md-4 d-none d-md-block mt-3"></div>
                          <div class="form-group col-md-8 mt-3">
                              <label for="inputAddress">Your Message</label>
                              <textarea class="form-control" name="s_message" aria-label="With textarea" placeholder="Your Message"></textarea>
                          ...
                          <div class="form-group mt-3 mt-md-0 col-md-4 align-self-end">
                            <div class="g-recaptcha" data-sitekey="6LcuUwEVAAAAAOF4b4IxvoXTo3TN09aaviVw2xaw" data-callback="verifyCaptcha"></div>
                            <div id="g-recaptcha-error"></div>
                          </div>
                          
                          <div class="wrap-btn col-md-12 mt-3">
                           <button type="submit" id="submit" name="submit" class="button btn-effect btn-submit" value="Book Service"> Book Test Drive </button>
                        </div>
