          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-md-6 col-lg-4">
                ...
                <select class="form-control custom-select w-100" name="for_insurance"  aria-required="true" aria-invalid="false" required="true">
            ...
            <button type="submit" name="submit" class="button btn-effect btn-submit" value="Submit"> Submit
            </button>
          </div>
          </form>
        </div>
