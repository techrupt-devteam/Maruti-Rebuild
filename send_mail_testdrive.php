 ...
 $headers = "From:" . $from;
    ...
    include('connection.php');
        ...
        if ($conn->query($sql) === TRUE) {
				...
				$msg ="Dear ".ucfirst($full_name).",\nThank you for your interest in the Maruti Suzuki ".ucfirst($model).".\nYour test drive for ".date('d-m-Y',strtotime($td_date))." at ".$td_time." has been booked and we look forward to seeing you!\nOur representative will get back to you shortly.\nRegards,\nTeam Seva Automotive";
