...
<section class="feature-car mt-4">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="section-title mb-4"> <span>Offer</span>
            <h2>Offer Enquiry </h2>
...
<div class="form-group">
          <p style="font-size:14px">
            ...
            <input type="checkbox" id="FormChkBoxBook6" name="FormChkBox" style="vertical-align: sub;" required="true" data-parsley-required-message="Please indicate that you accept the Terms and Conditions">
                I agree 
                <a href="disclaimer.php" style="color: blue">Terms and Conditions.</a> by clicking the ‘Continue’ button below and I am explicitly soliciting a call from Seva Maruti. Or its partners on my ‘Mobile’.
              </p>
          </div>
          <div class="wrap-btn mt-2"> 
        <button type="submit" name="submit" class ="button btn-effect btn-submit" value="Submit">Submit Now</button>
      </div>
</form>
    </div>
</div>
